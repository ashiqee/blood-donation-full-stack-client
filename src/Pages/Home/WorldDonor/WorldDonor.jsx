...
const WorldDonor = () => {
    return (
        <div>
            <SecTitle title={"Donor Day 2023"} subHeading={'Honoring Heroes: Donor Day Appreciation'} />
            <div className="bg-fixed bg-cover h-[500] items-center "
                ...
                <div className=" bg-gradient-to-r from-red-100 bg-opacity-60">
                    <div className="w-3/4 mx-auto  md:pl-56 py-20" >
                        <h2 className="md:text-9xl text-6xl font-semibold text-[#f34334]">WORLD</h2>


                        <div className="flex">
                            <h2 className="md:text-6xl text-3xl font-semibold text-[#f34334]">Blood Donor Day</h2>
